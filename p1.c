...
int main(){
	...
	// Erosão de forma a obter apenas a area do cerebro retirando o cranio
	...
	// Dilatacao para adicionar os pixeis do cerebro que foram retirados devido a erosao
	...
	// Apresentar todos os dados relativos a cada objeto
	printf("\nObjeto: Cerebro\n");
	for (i = 0; i < labels; i++)
	{
		printf("-> Area %d\n", blobs[i].area);
	...
	// Libertar espaço de memória ocupado pelas imagens 
